...
app.post('/api/pay', async(req, res) => {
    ...
    const callback_url = `https://ulesdinner.netlify.app/pages/success.html?email=${encodeURIComponent(email)}&name=${encodeURIComponent(name)}`;
